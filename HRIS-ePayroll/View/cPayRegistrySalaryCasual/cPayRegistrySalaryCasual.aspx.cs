...
{
    public partial class cPayRegistrySalaryCasual : System.Web.UI.Page
    {
        //********************************************************************
        ...
        private void RetrievePayrollInstallation()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lbl_installation_PERA_conv_hidden.Text = dt.Rows[0]["pera_days_conv"].ToString();
                hidden_hoursin1day.Text = dt.Rows[0]["hours_in_1day_conv"].ToString();
            }
        }

        //*************************************************************************
        //  BEGIN - VJA- 09/09/2018 - Populate Combo list for Employee Name
        //*************************************************************************
        ...
        //*************************************************************************
        //  BEGIN - VJA- 09/09/2018 - Populate Combo list for Groupings
        //*************************************************************************
        ...
        //*************************************************************************
        //  BEGIN - VJA- 09/09/2018 - Populate Combo list for Payroll Template
        //*************************************************************************
        ...
        {
            GetRegistry_NBR();
            dataListGrid = MyCmn.RetrieveData("sp_payrollregistry_dtl_ce_tbl_list", "par_payroll_year", ddl_year.SelectedValue.ToString().Trim(), "par_payroll_month", ddl_month.SelectedValue.ToString().Trim(), "par_payroll_registry_nbr", lbl_registry_no.Text.ToString().Trim(), "par_payrolltemplate_code", ddl_payroll_template.SelectedValue.ToString().Trim(), "par_payroll_group_nbr", GetRegistry_NBR());
        ...
        //*************************************************************************
        //  BEGIN - VJA- 09/09/2018 - Get The Next Registry Number
        //*************************************************************************
        ...
        private void ClearEntry()
        {
            ...
            txtb_lates_undertime_in_minute.Text = "0";
            txtb_lates_undertime_in_minute_in_amt.Text = "0.00";
            txtb_lwp.Text = "0.00";
            txtb_remarks.Text = "";
            txtb_wages_amt.Text = "0.00";
            ...
            txtb_lwp_spl.Text = "0.00";
            txtb_leave_earned.Text = "0.00";
            lbl_post_status.Text = "";

            txtb_pera_amount_net.Text = "0.00";
            txtb_wages_amt_net.Text = "0.00";
            txtb_lates_undertime_in_minute_in_amt_pera.Text = "0.00";
        ...
        private void InitializeTable()
        {
            ...
            dtSource.Columns.Add("wages_amt", typeof(System.String));
            ...
            dtSource.Columns.Add("lwpay_day", typeof(System.String));
            ...
            //Add Field Again   -- 09/09/2019
            dtSource.Columns.Add("lwpay_day_spl", typeof(System.String));
        ...
        {
            dtSource.TableName = "payrollregistry_dtl_ce_tbl";
        ...
        private void AddNewRow()
        {
            ...
            nrow["lwpay_day_spl"] = string.Empty;
        ...
        protected void btnDelete_Command(object sender, CommandEventArgs e)
        {
            ...
            else if (Session["ep_post_authority"].ToString() == "1")
            {
                ...
                else
                {
                    ...
                    MyCmn.UpdateTable("payrollregistry_dtl_ce_tbl", setparams, "WHERE " + deleteExpression);
                    RetrieveDataListGrid();
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop", "closeModalDelete();", true);
                }
            }
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Edit Row selection that will trigger edit page With String Session Variable
        //**************************************************************************
        private void editaddmodal(string session_val)
        {
                ...
                case "M":
                    {
                        ...
                        lbl_rate_descr.Text = row2Edit[0]["rate_basis_descr"].ToString() + " Rate :";
                        break;
                    }
                case "D":
                    {
            ...
            txtb_lwp.Text = row2Edit[0]["lwpay_day"].ToString();
            txtb_remarks.Text = row2Edit[0]["remarks"].ToString();
            txtb_lates_undertime_in_minute.Text = row2Edit[0]["lates_mins_hrs"].ToString();
            ...
            txtb_lwp_spl.Text = row2Edit[0]["lwpay_day_spl"].ToString() == "" ? "0.00" : row2Edit[0]["lwpay_day_spl"].ToString();
            txtb_lates_undertime_in_minute_in_amt_pera.Text = row2Edit[0]["lates_amount_pera"].ToString() == "" ? "0.00" : row2Edit[0]["lates_amount_pera"].ToString();
            txtb_lates_undertime_in_minute_in_amt.Text = row2Edit[0]["lates_amount"].ToString();
            ...
            calculate_optional();
            calculate_loans();
            leaveearned_computation();
            calculate_gross();
            calculate_netpays();
            // HDMF_PS_Computation();
            // HDMF_GS_Computation();
            CalculateIfNegativeValue();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (IsDataValidated())
            {
                ...
                if (saveRecord == MyCmn.CONST_ADD)
                {
                    ...
                    dtSource.Rows[0]["wages_amt"] = lbl_wages_amt_hidden.Text.ToString().Trim();
                    dtSource.Rows[0]["pera_amt"] = txtb_pera_amount.Text.ToString().Trim();
                    dtSource.Rows[0]["gross_pay"] = txtb_gross_pay.Text.ToString().Trim();
                    dtSource.Rows[0]["leave_earned"] = txtb_leave_earned.Text.ToString().Trim();
                    ...
                    dtSource.Rows[0]["lwpay_day"] = txtb_lwp.Text.ToString().Trim();
                    ...
                    dtSource.Rows[0]["lates_mins_hrs"] = txtb_lates_undertime_in_minute.Text.ToString().Trim();
                    dtSource.Rows[0]["lates_amount"] = txtb_lates_undertime_in_minute_in_amt.Text; ;
                    ...
                    dtSource.Rows[0]["gsis_ceap"] = txtb_gsis_ceap.Text.ToString().ToString().Trim();
                    ...
                    dtSource.Rows[0]["lwpay_day_spl"] = txtb_lwp_spl.Text.ToString().Trim();
                    dtSource.Rows[0]["lates_amount_pera"] = txtb_lates_undertime_in_minute_in_amt_pera.Text.ToString().Trim();
                ...
                if (saveRecord == MyCmn.CONST_ADD || saveRecord == MyCmn.CONST_EDIT)
                {
                    ...
                    if (saveRecord == MyCmn.CONST_ADD)
                    {
                        ...
                        nrow["daily_rate"] = txtb_rate_amount.Text.ToString().Trim();
                        nrow["wages_amt"] = lbl_wages_amt_hidden.Text.ToString().Trim();
                        nrow["pera_amt"] = txtb_pera_amount.Text.ToString().Trim();
                        nrow["gross_pay"] = txtb_gross_pay.Text.ToString().Trim();
                        nrow["leave_earned"] = txtb_leave_earned.Text.ToString().Trim();
                        ...
                        nrow["lwpay_day"] = txtb_lwp.Text.ToString().Trim();
                        ...
                        nrow["lates_mins_hrs"] = txtb_lates_undertime_in_minute.Text.ToString().Trim();
                        nrow["lates_amount"] = txtb_lates_undertime_in_minute_in_amt.Text; ;
                        ...
                        nrow["gsis_ceap"] = txtb_gsis_ceap.Text.ToString().ToString().Trim();
                        ...
                        nrow["posted_by_user"] = "";
                        nrow["date_posted"] = "1900-01-01";
                        nrow["position_title1"] = txtb_position.Text.ToString();

                        nrow["employee_name"] = ddl_empl_id.SelectedItem.ToString().Trim();
                        nrow["lwpay_day_spl"] = txtb_lwp_spl.Text.ToString().Trim();
                        nrow["lates_amount_pera"] = txtb_lates_undertime_in_minute_in_amt_pera.Text.ToString().Trim();
                    ...
                    if (saveRecord == MyCmn.CONST_EDIT)
                    {
                        ...
                        row2Edit[0]["wages_amt"] = lbl_wages_amt_hidden.Text.ToString().Trim();
                        row2Edit[0]["pera_amt"] = txtb_pera_amount.Text.ToString().Trim();
                        row2Edit[0]["gross_pay"] = txtb_gross_pay.Text.ToString().Trim();
                        row2Edit[0]["leave_earned"] = txtb_leave_earned.Text.ToString().Trim();
                        ...
                        row2Edit[0]["lwpay_day"] = txtb_lwp.Text.ToString().Trim();
                        ...
                        row2Edit[0]["lates_mins_hrs"] = txtb_lates_undertime_in_minute.Text.ToString().Trim();
                        row2Edit[0]["lates_amount"] = txtb_lates_undertime_in_minute_in_amt.Text;
                        ...
                        row2Edit[0]["gsis_ceap"] = txtb_gsis_ceap.Text.ToString().ToString().Trim();
                        ...
                        row2Edit[0]["lwpay_day_spl"] = txtb_lwp_spl.Text.ToString().Trim();
                        row2Edit[0]["lates_amount_pera"] = txtb_lates_undertime_in_minute_in_amt_pera.Text.ToString().Trim();
        ...
        protected void txtb_search_TextChanged(object sender, EventArgs e)
        {
            ...
            dtSource1.Columns.Add("wages_amt", typeof(System.String));
            dtSource1.Columns.Add("pera_amt", typeof(System.String));
            dtSource1.Columns.Add("gross_pay", typeof(System.String));
            dtSource1.Columns.Add("leave_earned", typeof(System.String));
            ...
            dtSource1.Columns.Add("lwpay_day", typeof(System.String));
            ...
            dtSource1.Columns.Add("lwpay_day_spl", typeof(System.String));
        ...
        private bool IsDataValidated()
        {
            ...
            if (CommonCode.checkisdecimal(txtb_lates_undertime_in_minute_in_amt) == false)
            {
                FieldValidationColorChanged(true, "txtb_lates_undertime_in_minute_in_amt");
                txtb_lates_undertime_in_minute_in_amt.Focus();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop_salary_tab", "click_salary_tab();", true);
                validatedSaved = false;
            }
            if (CommonCode.checkisdecimal(txtb_lates_undertime_in_minute_in_amt_pera) == false)
            {
                FieldValidationColorChanged(true, "txtb_lates_undertime_in_minute_in_amt_pera");
                txtb_lates_undertime_in_minute_in_amt_pera.Focus();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Pop_pera_tab", "click_pera_tab();", true);
                validatedSaved = false;
            }
            ...
            if (CommonCode.checkisdecimal(txtb_lates_undertime_in_minute) == false)
            {
                FieldValidationColorChanged(true, "txtb_lates_undertime_in_minute");
                txtb_lates_undertime_in_minute.Focus();
                validatedSaved = false;
            }
            ...
            if (CommonCode.checkisdecimal(txtb_lwp) == false)
            {
                FieldValidationColorChanged(true, "txtb_lwp");
                txtb_lwp.Focus();
                validatedSaved = false;
            }
            ...
            if (CommonCode.checkisdecimal(txtb_lwp_spl) == false)
            {
                FieldValidationColorChanged(true, "txtb_lwp_spl");
                txtb_lwp_spl.Focus();
                validatedSaved = false;
            }
            ...
            if (pMode)
                switch (pObjectName)
                {
                    ...
                    case "txtb_rate_amount":
                        {
                            LblRequired01.Text = MyCmn.CONST_INVALID_NUMERIC;
                            txtb_rate_amount.BorderColor = Color.Red;
                            break;
                        }
                    case "txtb_lates_undertime_in_minute_in_amt":
                        {
                            LblRequired101.Text = MyCmn.CONST_INVALID_NUMERIC;
                            txtb_lates_undertime_in_minute_in_amt.BorderColor = Color.Red;
                            break;
                        }
                    case "txtb_lates_undertime_in_minute_in_amt_pera":
                        {
                            LblRequired300.Text = MyCmn.CONST_INVALID_NUMERIC;
                            txtb_lates_undertime_in_minute_in_amt_pera.BorderColor = Color.Red;
                            break;
                        }
                    ...
                    case "txtb_lates_undertime_in_minute":
                        {
                            LblRequired33.Text = MyCmn.CONST_INVALID_NUMERIC;
                            txtb_lates_undertime_in_minute.BorderColor = Color.Red;
                            break;
                        }
                    case "txtb_gross_pay":
                        {
                    ...
                    case "txtb_lwp":
                        {
                            ...
                            txtb_lwp.BorderColor = Color.Red;
                            break;
                        }
                    ...
                    case "txtb_lwp_spl":
                        {
                            LblRequired202.Text = MyCmn.CONST_INVALID_NUMERIC;
                            txtb_lwp_spl.BorderColor = Color.Red;
                            break;
                        }
                    case "txtb_leave_earned":
                        {
                            LblRequired203.Text = MyCmn.CONST_INVALID_NUMERIC;
                            txtb_leave_earned.BorderColor = Color.Red;
                            break;
                        }
                    ...
                    case "ALL":
                        {
                            ...
                            txtb_lates_undertime_in_minute_in_amt.BorderColor = Color.LightGray;
                            txtb_lates_undertime_in_minute_in_amt_pera.BorderColor = Color.LightGray;
                            ...
                            txtb_lates_undertime_in_minute.BorderColor = Color.LightGray;
                            txtb_gross_pay.BorderColor = Color.LightGray;
                            txtb_lwo_pay.BorderColor = Color.LightGray;
                            txtb_lwp.BorderColor = Color.LightGray;
                            ...
                            txtb_lwp_spl.BorderColor = Color.LightGray;
                            txtb_leave_earned.BorderColor = Color.LightGray;
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Employment Type
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Department
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Sub-Department
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Division
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Section
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Year
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Open Modal Notification
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Payroll Group
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Payroll Temlpate
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Month
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Trigger When Select Employee
        //**************************************************************************
        ...
        private void HeaderDetails_Initialized_Add()
        {
            ...
            if (lbl_addeditmode_hidden.Text == MyCmn.CONST_ADD)
            {
                ...
                txtb_lates_undertime_in_minute.Text = row2Edit2[0]["under_Time"].ToString();
            }
            ...
            ///txtb_lwp_spl.Text = row2Edit2[0]["lwpay_day_spl"].ToString();
            ///
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Wages
        //**************************************************************************
        ...
        private void calculate_salary_summary_tab()
        {
            ...
            double prev_lwop_days = double.Parse(txtb_no_days_lwopay.Text);
        ...
        private void calculate_pera_summary_tab()
        {
            ...
            double pera_net = 0;
            pera_net = double.Parse(txtb_pera_amount.Text.ToString()) - (double.Parse(txtb_lates_undertime_in_minute_in_amt_pera.Text.ToString()) + double.Parse(txtb_lwop_amount_pera.Text.ToString()));
            txtb_pera_amount_net.Text = pera_net.ToString("###,##0.00").Trim();
            
        }
        
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Leave Earned and Lates In Amount
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Gross Amount
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Net Pay
        //**************************************************************************
        private void calculate_netpays()
        {
            ...
            // Ge Double nako kay pag e float, mo-kwaon niyang decimal point bsag fix na ang computation
            ...
            txtb_net_pay.Text = total_netpay.ToString("###,##0.00");

            //Net Pay for 1st Half (OLD COMPUTATION 10/15/2019)
                //total_pera_amount = float.Parse(txtb_pera_amount.Text.ToString()) - float.Parse(txtb_lwop_amount_pera.Text.ToString());
                //total_netpay1 = total_netpay / 2;
            ...
            //Net Pay for 2nd Half (OLD COMPUTATION 10/15/2019)
            ...
            //Net Pay for 2nd Half (NEW COMPUTATION 10/16/2019)
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Toogle Label Loan and Premiums
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Mandatory Tab
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Optional Tab
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Calculate Loan Tab
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Go to Laon Page with Session Variable
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Hidden button Triggers When it Back to This Page
        //**************************************************************************
        ...
        //**************************************************************************
        //  BEGIN - VJA- 04/06/2019 - Go to Other Contribution Page with Session Variable
        //**************************************************************************
        ...
        private void ToogleTextbox(bool ifenable)
        {
            ...
            txtb_lwp.Enabled                       = ifenable;
            txtb_rate_amount.Enabled                       = ifenable;
            txtb_remarks.Enabled                   = ifenable;
            txtb_lates_undertime_in_minute.Enabled = ifenable;
            ...
            txtb_lwp_spl.Enabled                    = ifenable;
            txtb_lates_undertime_in_minute_in_amt.Enabled                    = ifenable;
            txtb_lates_undertime_in_minute_in_amt_pera.Enabled                    = ifenable;
        ...
        protected void lnkPrint_Click(object sender, EventArgs e)
        {
            ...
            switch (ddl_select_report.SelectedValue)
            {
                case "01": // PaySLip  - For Regular 
                    ...
                    url = "/printView/printView.aspx?id=~/Reports/" + printreport + "," + procedure + ",par_payroll_year," + ddl_year.SelectedValue.ToString().Trim() + ",par_payroll_month," + ddl_month.SelectedValue.ToString().Trim() + ",par_payroll_registry_nbr," + lnkPrint.CommandArgument.Split(',')[1].ToString().Trim() + ",par_payrolltemplate_code," + "214" + ",par_empl_id," + lnkPrint.CommandArgument.Split(',')[0].ToString().Trim();
                    break;
        ...
        //**************************************************************************
        //  BEGIN - VJA- 01/28/2019 - Check if Negative Calculate 
        //*************************************************************************
        private void CalculateIfNegativeValue()
        {
            /// ----VJA : 2020/01/28 - SEPARATE COMPUTATION FOR NEGATIVE NET PAY------------------------------//
            double gross_pay = 0;
            ...
            total_deduction = double.Parse(txtb_total_mandatory.Text) + double.Parse(txtb_total_optional.Text) + double.Parse(txtb_total_loans.Text);
            gross_pay = double.Parse(txtb_wages_amt.Text.ToString()) - (double.Parse(txtb_lates_undertime_in_minute_in_amt.Text.ToString()) + double.Parse(txtb_lwo_pay.Text.ToString()));

            if (double.Parse(txtb_sss.Text) != 0 && total_deduction >= gross_pay)
            {
                if (double.Parse(txtb_pera_amount.Text.ToString()) < 2000 || double.Parse(txtb_lwop_amount_pera.Text.ToString()) > 0 || double.Parse(txtb_lates_undertime_in_minute_in_amt_pera.Text.ToString()) > 0)
                {
                    total_pera_amount = double.Parse(txtb_pera_amount.Text.ToString()) - (double.Parse(txtb_lwop_amount_pera.Text.ToString()) - double.Parse(txtb_lates_undertime_in_minute_in_amt_pera.Text.ToString()));
                    total_netpay1 = ((total_netpay - total_pera_amount) - double.Parse(txtb_sss.Text)) / 2;
                    total_netpay1 = total_netpay1 - (total_netpay1 % 1);
                    total_netpay1 = total_netpay1 + total_pera_amount;
                    txtb_net_pay_1h.Text = total_netpay1.ToString("###,##0.00");
                }
                else
                {
                    string total_str_netpay1 = "";
                    total_pera_amount = double.Parse(txtb_pera_amount.Text.ToString()) - double.Parse(txtb_lwop_amount_pera.Text.ToString());
                    total_netpay1 = (((total_netpay - total_pera_amount) - double.Parse(txtb_sss.Text)) / 2) + total_pera_amount;
                    total_str_netpay1 = total_netpay1.ToString("###,##0.0000");
                    txtb_net_pay_1h.Text = total_str_netpay1.Split('.')[0] + ".00";
                }


                total_netpay2 = ((double.Parse(txtb_net_pay.Text.ToString()) - total_pera_amount) + double.Parse(txtb_sss.Text)) / 2;
                total_netpay2 = total_netpay2 + (total_netpay2 % 1);
                txtb_net_pay_2h.Text = total_netpay2.ToString("###,#00.00");
            }
            /// -----VJA : 2020/01/28 - SEPARATE COMPUTATION FOR NEGATIVE NET PAY------------------------------//
        ...
        //**************************************************************************
        //  BEGIN - VJA- 09/12/2018 - Computation for HDMF PS During the Calculate 
        //                              Button Triggres
        //  Computation     
        //**************************************************************************
        private void HDMF_PS_Computation()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                ////----------------NEW UPDATE BY SIR ARIEL--------------//
                //// 1. ) Kung -1 ang amount       = ma 0.00 ang amount
                //// 2. ) Kung 0 ug amount         = ma 0.00 ang amount
                //// 3. ) Kung butangan ug amount  =  ma Override ( sa Textbox gikan)

                //total_hdmf_ps_new = float.Parse(txtb_wages_amt.Text) * (float.Parse(dt.Rows[0]["personal_share"].ToString()) / 100);

                //if (float.Parse(txtb_hdmf_ps.Text) <= -1)
                //{
                //    txtb_hdmf_ps.Text = total_hdmf_ps.ToString("###,##0.00");
                //}
                //// Additional Condition : 01-09-2020 - JADE
                //// - Special Case : Pag nag Maternity ang Employee, Dapat 0 ang amount sa PS and GS HDMF
                ////   Kung walay Amount ang HDMF GS , mag expect ta nga 0 ang amount sa HDMF PS, mao nang 
                ////                      pwedi sya ma override.
                //else if (float.Parse(txtb_hdmf_ps.Text) == 0 && float.Parse(txtb_hdmf_gs.Text) == 0)
                //{
                //    total_hdmf_ps = float.Parse(txtb_hdmf_ps.Text);
                //    txtb_hdmf_ps.Text = total_hdmf_ps.ToString("###,##0.00");
                //}
                //else if (float.Parse(txtb_hdmf_ps.Text) == 0)
                //{
                //    total_hdmf_ps = total_hdmf_ps_new;
                //    txtb_hdmf_ps.Text = total_hdmf_ps.ToString("###,##0.00");
                //}
                //else if (total_hdmf_ps_new != float.Parse(txtb_hdmf_ps.Text))
                //{
                //    total_hdmf_ps = float.Parse(txtb_hdmf_ps.Text);
                //    txtb_hdmf_ps.Text = total_hdmf_ps.ToString("###,##0.00");
                //}
                ...
                if (dt.Rows[0]["maximum_ps_type"].ToString() == "F")
                    ...
                    {
                    // Old Computation that Drop the 3rd Digit
                    // float total_hdmf_ps = 0;
                    // string total_str_total_hdmf_ps = "";
                    // 
                    // total_hdmf_ps = float.Parse(txtb_wages_amt.Text) * (float.Parse(dt.Rows[0]["personal_share"].ToString()) / 100);
                    // total_str_total_hdmf_ps = total_hdmf_ps.ToString("###,##0.0000");
        ...
        //**************************************************************************
        //  BEGIN - VJA- 2020-07-16 - Computation for HDMF GS During the Calculate 
        //                              Button Triggres Computation     
        //**************************************************************************
