<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cAccountClass.aspx.cs" Inherits="HRIS_ePayroll.View.cAccountClass" %>
            ...
            <ContentTemplate>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" >
                                <div class="col-12" >
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                                <label class="font-weight-bold" Style="float:left; margin-right:5px" >Account Class Code:</label>
                        ...
                        <div class="row" >
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Account Class Short Description:"></asp:Label>
                                ...
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Account Class Description:"></asp:Label>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                           <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="acctclass_code">
                                                    <ItemTemplate>
                                                        <%# Eval("acctclass_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="15%" />
                                                ...
                                                <asp:TemplateField HeaderText="SHORT DESCRIPTION" SortExpression="acctclass_short_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("acctclass_short_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="DESCRIPTION" SortExpression="acctclass_descr">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("acctclass_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("acctclass_code") + ", " + Eval("acctclass_code") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
