<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPayTemplate.aspx.cs" Inherits="HRIS_ePayroll.View.cPayTemplate.cPayTemplate" %>
                        ...
                        <div class="row" runat="server">
                            <div class="col-12">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <Label ID="Label1" style="float:left;margin-right:10px"><strong>Template Code:</strong></Label>
                                        <asp:TextBox ID="txtb_code" runat="server" Width="15%" CssClass="form-control form-control-sm text-center" Font-Bold="true" style="float:left" Enabled ="false"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                            <div class="col-12" >
                            ...
                            <div class="form-group col-md-6">
                                <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold"  Text="Template Type:"></asp:Label>
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddl_payroll_type" runat="server" CssClass="form-control form-control-sm" AutoPostBack="true">
                                        </asp:DropDownList>
                            ...
                            <div class="form-group col-md-6">
                                    <asp:Label ID="Label8" runat="server" CssClass="font-weight-bold"  Text="Payment Mode:"></asp:Label>
                                ...
                                <div class="form-group col-md-12" >
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_report_filename" runat="server" Width="100%" CssClass="form-control form-control-sm"></asp:TextBox>
                                            <asp:Label ID="LblRequired4" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Template Short Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_short_descr"  runat="server"  MaxLength="30"  Width="100%" CssClass="form-control-sm form-control"></asp:TextBox>
                                            <asp:Label ID="LblRequired1" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Template Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_descr" TextMode="MultiLine" Height = "80px" runat="server" MaxLength="255"  Width="100%" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="row" style="margin-bottom:10px">
                                ...
                                <div class="col-7">
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="Label5" runat="server" Text="Employment Type:" style="float:left;margin-right:10px"></asp:Label>
                                            <asp:DropDownList ID="ddl_empl_type" runat="server" CssClass="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="ddl_empl_type_SelectedIndexChanged" Width="75%" style="float:left"></asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                ...
                                <div class="col-7">
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:Label ID="Label7" runat="server" Text="Template Type:" style="float:left;margin-right:31px;margin-top:3px;"></asp:Label>
                                            <asp:DropDownList ID="ddl_template_type" runat="server" CssClass="form-control form-control-sm" AutoPostBack="true" OnselectedIndexChanged="ddl_template_type_SelectedIndexChanged" Width="75%" style="float:left;margin-top:3px;"></asp:DropDownList>
                                ...
                                <ContentTemplate>
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="SHORT DESCRIPTION" SortExpression="payrolltemplate_short_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("payrolltemplate_short_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <%--<asp:TemplateField HeaderText="TEMPLATE TYPE" SortExpression="templatetype_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("templatetype_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("payrolltemplate_code") + ", " + Eval("payrolltemplate_short_descr") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
