<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPayTemplateAccount.aspx.cs" Inherits="HRIS_ePayroll.View.cPayTemplateAccount.cPayTemplateAccount" %>
    ...
    <!-- The Modal - Add Confirmation -->
                        ...
                        <div class="row" runat="server">
                                <div class="col-6">
                                    <div class="form-group row">
                                        <div class="col-6">
                                            <asp:Label ID="Label11" runat="server" CssClass="font-weight-bold"  Text="Employment Type:"></asp:Label>
                                        </div>
                                        <div class="col-6">
                                            <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                                                <ContentTemplate>
                                                     <asp:TextBox runat="server" CssClass="form-control form-control-sm" ID="txtb_empl_type_disabled" Enabled="false" Style="letter-spacing:1px" Font-Bold="true"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        <div class="col-5">
                                            <asp:Label ID="Label13" runat="server" CssClass="font-weight-bold"  Text="Payroll Template:"></asp:Label>
                                        </div>
                                        <div class="col-7">
                                            <asp:UpdatePanel ID="UpdatePanel18" runat="server">
                                                <ContentTemplate>
                                                     <asp:TextBox runat="server" CssClass="form-control form-control-sm" ID="txtb_payroll_template_disabled" Enabled="false" Font-Bold="true" style="letter-spacing:1px"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        <div class="col-3">
                                            <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Account Title:"></asp:Label>
                                        </div>
                                        <div class="col-9">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_account" runat="server"  CssClass="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="ddl_account_SelectedIndexChanged"></asp:DropDownList>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        <div class="col-3">
                                            <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Sub Account Title:"></asp:Label>
                                        </div>
                                        <div class="col-9">
                                            <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_subaccount" runat="server"  CssClass="form-control form-control-sm"></asp:DropDownList>
                                ...
                                <div class="col-12">
                                    <div class="form-group row">
                                        <div class="col-3">
                                            <asp:Label ID="Label8" runat="server" CssClass="font-weight-bold"  Text="Related Account:"></asp:Label>
                                        </div>
                                        <div class="col-9">
                                            <asp:UpdatePanel ID="UpdatePanel19" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_related_acct" runat="server"  CssClass="form-control form-control-sm"></asp:DropDownList>
                                ...
                                <div class="col-9">
                                    <div class="form-group row">
                                        <div class="col-4">
                                            <asp:Label ID="Label5" runat="server" CssClass="font-weight-bold"  Text="Group Name:"></asp:Label>
                                        </div>
                                        <div class="col-8">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_account_group_code" runat="server"  CssClass="form-control form-control-sm"></asp:DropDownList>
                                ...
                                <div class="col-3">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                                <asp:Label ID="Label9" runat="server" CssClass="font-weight-bold" Font-Size="Small" Text="Column Order:" style="float:left;margin-right:10px"></asp:Label>
                                                <asp:TextBox runat="server" CssClass="form-control form-control-sm text-center" ID="txtb_report_column_order" style="float:left; width:35%" MaxLength="3"></asp:TextBox>
                                                <asp:Label ID="LblRequired4" CssClass="lbl_required" style="float:right !important;margin-right:10px !important" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-12" runat="server" id="container_of_reference" >
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <hr style="margin-top:5px;margin-bottom:5px" />
                                        </div>
                                        <div class="col-3">
                                            <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold"  Text="Reference Table:"></asp:Label>
                                        </div>
                                        <div class="col-9">
                                            <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_ref_table" runat="server"  CssClass="form-control form-control-sm" AutoPostBack="true" OnSelectedIndexChanged="ddl_ref_table_SelectedIndexChanged"></asp:DropDownList>
                                                     <asp:Label ID="LblRequired7" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                        <div class="col-3" style="margin-top:2px">
                                             <asp:Label ID="Label6" runat="server" CssClass="font-weight-bold"  Text="Reference Field:"></asp:Label>
                                        </div>
                                        <div class="col-9" style="margin-top:2px">
                                            <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_ref_field" runat="server"  CssClass="form-control form-control-sm"></asp:DropDownList>
     ...
     <div class="col-12">
            <div class="row breadcrumb my-breadcrumb">
                <div class="col-5"><strong style="font-family:Arial;font-size:20px;color:white;"><%: Master.page_title %></strong></div>
                <div class="col-7">
                        ...
                        <td>
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_payrolltemplate" runat="server" CssClass="form-control-sm form-control" OnSelectedIndexChanged="ddl_payrolltemplate_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="ACCT. CODE" SortExpression="account_code">
                                                    <ItemTemplate>
                                                        <%# Eval("account_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                               ...
                                               <asp:TemplateField HeaderText="SUB ACCOUNT TITLE" SortExpression="account_sub_title">
                                                    <ItemTemplate>
                                                        &nbsp;&nbsp;<%# Eval("account_sub_title") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="LEFT" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ORDER" SortExpression="report_column_order">
                                                    <ItemTemplate>
                                                        <%# Eval("report_column_order") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="5%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="center" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("payrolltemplate_code") + "," + Eval("account_code") + "," + Eval("account_sub_code")%>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("payrolltemplate_code") + "," + Eval("account_code") + "," + Eval("account_sub_code")%>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                ...
                                <Triggers>
                                    ...
                                    <asp:AsyncPostBackTrigger ControlID="ddl_payrolltemplate" />
