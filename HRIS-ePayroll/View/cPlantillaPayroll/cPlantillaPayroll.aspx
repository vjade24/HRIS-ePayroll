<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPlantillaPayroll.aspx.cs" Inherits="HRIS_ePayroll.View.cPlantillaPayroll" %>
            ...
            <ContentTemplate>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" >
                                <div class="col-12" >
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                                <label class="font-weight-bold" Style="float:left; margin-right:5px" >Payroll Year:</label>
                                                <asp:TextBox ID="txtb_payroll_year" runat="server" Enabled="false" Width="20%" Style="float:left" Font-Bold="true" CssClass="form-control form-control-sm text-center" MaxLength="04"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                        </div> 
                        ...
                        <div class="row" >
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Employment Type:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                        <asp:DropDownList ID="ddl_empl_type" runat="server"  CssClass="form-control-sm form-control" AutoPostBack="false"></asp:DropDownList>
                                     </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Budget Year:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                        <asp:DropDownList ID="ddl_budget_year" runat="server"  CssClass="form-control-sm form-control" AutoPostBack="false"></asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                           </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-2">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_year" runat="server" style="padding-left:10%" CssClass="form-control-sm form-control" OnSelectedIndexChanged="ddl_year_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                           <Columns>
                                                <asp:TemplateField HeaderText="BUDGET YEAR" SortExpression="budget_description">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("budget_description") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="EMPLOYMENT TYPE" SortExpression="employmenttype_description">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("employmenttype_description") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("payroll_year") + ", " + Eval("budget_code") + ", " + Eval("employment_type") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
