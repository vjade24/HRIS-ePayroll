...
{
    public partial class cEmplCNAIncentive : System.Web.UI.Page
    {
        //********************************************************************
        ...
        {
            dataListGrid = MyCmn.RetrieveData("sp_cnaincentive_tbl_list", "par_payroll_year", ddl_year.SelectedValue.ToString().Trim(), "par_employment_type", ddl_empl_type.SelectedValue.ToString().Trim(), "par_department_code", ddl_department.SelectedValue.ToString().Trim(), "par_subdepartment_code", ddl_subdep.SelectedValue.ToString().Trim(), "par_division_code", ddl_division.SelectedValue.ToString().Trim(), "par_section_code", ddl_section.SelectedValue.ToString().Trim());
        ...
        private void ClearEntry()
        {
            ...
            txtb_amount.Text = "";
            txtb_agency_fee.Text = "";
            //txtb_subaccount_code.ReadOnly = false;
            txtb_empl_id_hidden.Visible = false;
        ...
        private void AddNewRow()
        {
            ...
            nrow["incentive_amount"] = string.Empty;
            nrow["agency_fee"] = string.Empty;
        ...
        private void InitializeTable()
        {
            ...
            dtSource.Columns.Add("incentive_amount", typeof(System.String));
            dtSource.Columns.Add("agency_fee", typeof(System.String));
        ...
        {
            dtSource.TableName = "cnaincentive_tbl";
        ...
        protected void btnDelete_Command(object sender, CommandEventArgs e)
        {
            ...
            MyCmn.DeleteBackEndData("cnaincentive_tbl", "WHERE " + deleteExpression);
        ...
        protected void editRow_Command(object sender, CommandEventArgs e)
        {
            ...
            RetrieveEmpl();
            //ddl_empl_id.SelectedValue = svalues;
            txtb_empl_id.Text = svalues;
            txtb_empl_id_hidden.Text = row2Edit[0]["employee_name"].ToString();
            txtb_empl_id_hidden.Visible = true;
            ddl_empl_id.Visible = false;

            txtb_amount.Text = row2Edit[0]["incentive_amount"].ToString();
            ddl_status.Text = row2Edit[0]["recrd_status"].ToString();
            txtb_agency_fee.Text = row2Edit[0]["agency_fee"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (IsDataValidated())
            {
                if (saveRecord == MyCmn.CONST_ADD)
                {
                    ...
                    dtSource.Rows[0]["agency_fee"] = float.Parse(txtb_agency_fee.Text).ToString("###,##0.00");
                    dtSource.Rows[0]["incentive_amount"] = float.Parse(txtb_amount.Text).ToString("###,##0.00");
                ...
                if (saveRecord == MyCmn.CONST_ADD || saveRecord == MyCmn.CONST_EDIT)
                {
                    ...
                    if (saveRecord == MyCmn.CONST_ADD)
                    {
                        ...
                        //nrow["employee_name"] = txtb_empl_id.Text.ToString().Trim();
                        nrow["agency_fee"] = float.Parse(txtb_agency_fee.Text).ToString("###,##0.00");
                        nrow["incentive_amount"] = float.Parse(txtb_amount.Text).ToString("###,##0.00");
                    ...
                    if (saveRecord == MyCmn.CONST_EDIT)
                    {
                        ...
                        row2Edit[0]["employee_name"] = txtb_empl_id_hidden.Text.ToString().Trim();
                        row2Edit[0]["agency_fee"] = float.Parse(txtb_agency_fee.Text).ToString("###,##0.00");
                        row2Edit[0]["incentive_amount"] = float.Parse(txtb_amount.Text).ToString("###,##0.00");
        ...
        {
            string searchExpression = "empl_id LIKE '%" + txtb_search.Text.Trim().Replace("'", "''").Replace("%", "") + "%' OR employee_name LIKE '%" + txtb_search.Text.Trim().Replace("'", "''").Replace("%", "") + "%' OR incentive_amount LIKE '%" + txtb_search.Text.Trim().Replace("'", "''").Replace("%", "") + "%' OR agency_fee LIKE '%" + txtb_search.Text.Trim().Replace("'", "''").Replace("%", "") + "%'";

            DataTable dtSource1 = new DataTable();

            dtSource1.Columns.Add("empl_id", typeof(System.String));
            dtSource1.Columns.Add("employee_name", typeof(System.String));
            dtSource1.Columns.Add("agency_fee", typeof(System.String));
            dtSource1.Columns.Add("incentive_amount", typeof(System.String));
        ...
        private bool IsDataValidated()
        {
           ...
           if (txtb_agency_fee.Text == "")
            {
                FieldValidationColorChanged(true, "txtb_agency_fee");
                txtb_agency_fee.Focus();
                validatedSaved = false;
            }
            if (CommonCode.checkisdecimal(txtb_agency_fee) == false)
            {
                FieldValidationColorChanged(true, "invalid-txtb_agency_fee");
                txtb_agency_fee.Focus();
                validatedSaved = false;
            }
        ...
        protected void FieldValidationColorChanged(bool pMode, string pObjectName)
        {
            if (pMode)
                switch (pObjectName)
                {
                    ...
                    case "txtb_agency_fee":
                        {
                            LblRequired4.Text = MyCmn.CONST_RQDFLD;
                            txtb_agency_fee.BorderColor = Color.Red;
                            break;
                        }
                    case "invalid-txtb_agency_fee":
                        {
                    ...
                    case "ALL":
                        {
                            ...
                            txtb_agency_fee.BorderColor = Color.LightGray;
                            break;
                        }
