<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cEmplCNAIncentive.aspx.cs" Inherits="HRIS_ePayroll.View.cEmplCNAIncentive" %>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="col-12">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:TextBox ID="txtb_empl_id_hidden" runat="server" CssClass="form-control form-control-sm" Enabled="false"></asp:TextBox>
                                        ...
                                        <div class="col-6">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtb_amount" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>
                                ...
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Agency Fee:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_agency_fee" runat="server" MaxLength="255" Width="100%" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="AMOUNT" SortExpression="comm__amount">
                                                    <ItemTemplate>
                                                        <%# Eval("incentive_amount") %>&nbsp;&nbsp;
                                                    </ItemTemplate>
                                                    <ItemStyle Width="20%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="RIGHT" />
                                                </asp:TemplateField>
                                               <asp:TemplateField HeaderText="AGENCY FEE" SortExpression="agency_fee">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("agency_fee") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="20%" />
