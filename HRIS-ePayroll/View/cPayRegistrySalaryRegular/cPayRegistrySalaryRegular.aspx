<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPayRegistrySalaryRegular.aspx.cs" Inherits="HRIS_ePayroll.View.cPayRegistrySalaryRegular" %>
    ...
    <form runat="server">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)" >
                        ...
                        <div class="modal-body with-background" runat="server"  style="padding-top: 5px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9" style="padding-left:0px">
                                    <asp:UpdatePanel ID="UpdateDep" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_dep" runat="server" CssClass="form-control form-control-sm font-weight-bold" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="ddl_dep_SelectedIndexChanged" Enabled="false"></asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-3" >
                                    <asp:label runat="server" Font-Bold="true" Text="LWOP Days:" ></asp:label>
                                </div>
                                ...
                                <div class="col-2" style="padding-right:0px">
                                    <asp:label runat="server" Font-Bold="true" Text="Lates (in min):" ></asp:label>
                                </div>
                                <div class="col-1" style="padding-left:0px">
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox runat="server" ID="txtb_lates_in_min" CssClass="form-control form-control-sm text-right"></asp:TextBox>
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <div class="row" runat="server" ID="id_days_hours">
                                            ...
                                            <div class="col-3">
                                                <asp:label runat="server" Font-Bold="true" Text="No. of Hours Worked:" Visible="false"></asp:label>
                                            </div>
                                            <div class="col-3">
                                                <asp:UpdatePanel runat="server">
                                                    <ContentTemplate>
                            ...
                            <div class="row">
                                <%--<div class="col-12" style="margin-top:-10px">
                                    <asp:Image runat="server" ImageUrl="~/ResourceImages/line_small.png" Width="100%"/>
                                </div>--%>
                                <div class="col-12">
                                    <hr style="margin-top:5px;margin-bottom:5px" />
                                </div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    <asp:Label runat="server" class="font-weight-bold" Font-Size="Smaller"  ID="lbl_rate_descr" Text="Monthly Rate:" ></asp:Label>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                        <div class="col-6">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox runat="server" ID="txtb_rate_amount" CssClass="form-control form-control-sm text-right font-weight-bold" Text="0.00" ></asp:TextBox>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-6">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox runat="server" ID="txtb_late_in_amount" CssClass="form-control form-control-sm text-right"  Font-Bold="true"></asp:TextBox>
                                                    
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div> 
                                                        <div class="col-6" style="padding-right:0px !important">
                                                            <asp:label runat="server" Font-Bold="true" Text="Net - Sal. Amt:"  Font-Size="Small"></asp:label>
                                                        </div>
                                                        <div class="col-6">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <asp:Label runat="server" CssClass="lbl_required" ID="LblRequired600"></asp:Label>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div> 
                                                        ...
                                                        <div class="col-6" style="display:none">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    <asp:TextBox runat="server" ID="txtb_late_in_amount_pera" CssClass="form-control form-control-sm text-right" Font-Bold="true"></asp:TextBox>
                                ...
                                <div class="col-8" style="padding-left:20px">
                                    ...
                                    <div class="col-12">
                                        <ul class="nav nav-tabs" style="border-bottom: 1px solid #dee2e6" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                            <a class="nav-link active" id="id_mandatory" data-toggle="tab" href="#mandatory_tab" role="tab" aria-controls="mandatory_tab" aria-selected="false" style="font-weight:bold" aria-expanded="true">MANDATORY</a>
                                            </li>
                                            <li class="nav-item">
                                            <a class="nav-link" id="id_optional" data-toggle="tab" href="#optional_tab" role="tab" aria-controls="optional_tab" aria-selected="false" style="font-weight:bold">OPTIONAL</a>
                                            </li>
                                            <li class="nav-item">
                                            <a class="nav-link" id="id_loans" data-toggle="tab" href="#loans_tab" role="tab" aria-controls="loans_tab" aria-selected="false" style="font-weight:bold">LOANS</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="tab-content" id="myTabContent" style="width:100%">
                                        <%--MANDATORY DEDUCTIONS--%>
                                        <div class="tab-pane fade show active"  id="mandatory_tab" role="tabpanel" style="border: 1px solid green;padding-bottom:5px;border-radius:0px 0px 5px 5px;padding-left:10px;padding-right:10px;min-height: 300px;margin-bottom: 10px;margin-right: 15px;" aria-labelledby="id_mandatory">
                                        ...
                                        <%--OPTIONAL DEDUCTIONS--%>
                                        <div class="tab-pane fade" id="optional_tab" role="tabpanel" style="border: 1px solid green;padding-bottom:5px;border-radius:0px 0px 5px 5px;padding-left:10px;padding-right:10px;min-height: 300px;margin-bottom: 10px;margin-right: 15px;" aria-labelledby="id_optional">
                                        ...
                                        <%--LOANS--%>
                                        <div class="tab-pane fade" id="loans_tab" role="tabpanel" style="border: 1px solid green;padding-bottom:5px;border-radius:0px 0px 5px 5px;padding-left:10px;padding-right:10px;min-height: 300px;margin-bottom: 10px;margin-right: 15px;" aria-labelledby="id_loans">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="col-4">
                                                       ...
                                                       <%-- END     - VJA - 2022-05-27 - RESERVED DEDUCTIONS--%>
                                                        ...
                                                        <div class="col-12" style="padding:0px;padding-right:5px;margin-top:25px;display:none">
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                        ...
                                        <div class="col-12" style="padding:0px">
                                            <hr style="margin-top:5px;margin-bottom:5px;margin-right:15px" />
                                        </div>
                                        <div class="col-6" style="padding:0px">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                 <asp:Label runat="server" ID="lbl_if_dateposted_yes" CssClass="col-form-label-sm text-danger" Font-Bold="true" style="font-size:12px"></asp:Label>
                                    ...
                                    <div class="col-6">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Label runat="server" ID="lbl_hours_in_1day" Visible="false" ></asp:Label>
     ...
     <div class="col-12">
            <div class="row breadcrumb my-breadcrumb">
                <div class="col-3"><strong style="font-family:Arial;font-size:18px;color:white;">Monthly Payroll (Regular)</strong></div>
                <div class="col-9">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel10" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <% if (ViewState["page_allow_add"].ToString() == "1"
                                                ...
                                                {  %>
                                            <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-sm add-icon icn"  Text="Add" OnClick="btnAdd_Click" ToolTip="Add Record"/>
                                            <% }
                                                %>     
                                        </ContentTemplate>
                                        <Triggers>
                                                            ...
                                                            <ContentTemplate>
                                                                ...
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" 
                                                                        ...
                                                                        CommandArgument='<%# Eval("empl_id") + "," + Eval("payroll_registry_nbr") + "," + Eval("payroll_year")%> ' 
                                                                        Enabled='<%# Eval("post_status").ToString() == "N" || Eval("post_status").ToString() == "T" ? true : false %>'
...
<asp:Content ID="Content3" ContentPlaceHolderID="specific_scripts" runat="server">
  <script>
    ...
    <script type="text/javascript">
        ...
        function show_date()
            {
                $('#<%= txtb_date_posted.ClientID %>').datepicker({ format: 'yyyy-mm-dd' });
