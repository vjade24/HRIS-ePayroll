...
namespace HRIS_ePayroll.View.cEmployeeTaxRateDetails
{

    
    public partial class cEmployeeTaxRateDetails : System.Web.UI.Page
    {
        //********************************************************************
        ...
        void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else if (Session["PreviousValuesonPage_cEmployeeTaxRate"].ToString() != string.Empty)
                {
                    ...
                    txtb_department.Text    = prevValues[1].ToString();
                    txtb_empl_id_hdr.Text   = prevValues[2].ToString();
                    txtb_bus_tax_hdr.Text   = prevValues[3].ToString();
                    txtb_bus_tax.Text       = prevValues[3].ToString();
                    txtb_wheld_tax.Text     = prevValues[4].ToString();
                    txtb_w_tax.Text         = prevValues[4].ToString();
        ...
        private void RetrieveDataListGrid()
        {
            ...
            dataListGrid = MyCmn.RetrieveData("sp_payrollemployee_tax_dtl_tbl_list_ACT", "par_payroll_year", txtb_payroll_year.Text.ToString().Trim(), "par_empl_id", txtb_empl_id_hdr.Text.ToString().Trim());
        ...
        private void ClearEntry()
        {
            ...
            ddl_month.SelectedValue = monthValue;
        ...
        protected void editRow_Command(object sender, CommandEventArgs e)
        {
            ...
            string[] svalues = e.CommandArgument.ToString().Split(',');
            string editExpression = "empl_id = '" + svalues[0].ToString().Trim()+ "' AND effective_date ='" + svalues[1].ToString().Trim() + "' AND voucher_nbr ='" + svalues[2].ToString().Trim() + "'";
            ...
            txtb_pera_ca.Text                   = row2Edit[0]["pera_ca_amt"].ToString();
            txtb_gsis.Text                      = row2Edit[0]["gsis_ps"].ToString();
            txtb_phic.Text                      = row2Edit[0]["phic_ps"].ToString();
            txtb_hdmf.Text                      = row2Edit[0]["hdmf_ps"].ToString();
            txtb_hazard.Text                    = row2Edit[0]["hazard_pay"].ToString();
            txtb_subs_allo.Text                 = row2Edit[0]["subsistence_allowance"].ToString();
            txtb_laundry.Text                   = row2Edit[0]["laundry_allowance"].ToString();
            txtb_gross.Text                     = row2Edit[0]["gross_pay"].ToString();
            txtb_wheld.Text                     = row2Edit[0]["wtax_amt"].ToString();
            txtb_remarks.Text                   = row2Edit[0]["remarks"].ToString();
            txtb_payroll_template.Text          = row2Edit[0]["payrolltemplate_descr"].ToString();
            txtb_month.Text                     = ddl_month.SelectedItem.Text.ToString();
            txtb_payroll_template.Visible       = false;
