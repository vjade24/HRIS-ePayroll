<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cEmplFixedDays.aspx.cs" Inherits="HRIS_ePayroll.View.cEmplFixedDays.cEmplFixedDays" %>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue);">
                        ...
                        <div class="row" runat="server">
                            <div class ="col-3">
                                <asp:Label ID="Label1" runat="server" CssClass="font-weight-bold"  Text="Employee Name:"></asp:Label>
                            </div>
                            <div class ="col-6" >
                                <%--<asp:TextBox ID="txtb_empl_name" Visible="true" runat="server" Width="100%" CssClass="form-control form-control-sm" Enabled="false" Style="font-weight: bold; letter-spacing: 3px;"></asp:TextBox>--%>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="ddl_empl_id" runat="server" CssClass="form-control form-control-sm" OnSelectedIndexChanged="ddl_empl_id_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                            <asp:TextBox ID="txtb_empl_name_edit" Visible="false" Enabled="false" runat="server" Width="100%" CssClass="form-control form-control-sm" Style="font-weight: bold; letter-spacing: 3px;"></asp:TextBox>
                                        <asp:Label ID="LblRequired1" runat="server" CssClass="lbl_required" Text=""></asp:Label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                            <div class ="col-1" style="padding-right:0px">
                                <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="ID No:"></asp:Label>
                            </div>

                            <div class ="col-2">
                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtb_empl_id" Visible="true" Enabled="false" runat="server" Width="100%" CssClass="form-control form-control-sm text-center" Style="font-weight: bold; letter-spacing: 3px;"></asp:TextBox>
                            ...
                            <div class="col-12">
                             ...
                             <div class ="col-3">
                                <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold"  Text="Position Title:"></asp:Label>
                            </div>
                            <div class ="col-9">
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtb_position" Visible="true" Enabled="false" runat="server" Width="100%" CssClass="form-control form-control-sm" Style="font-weight: bold; letter-spacing: 3px;"></asp:TextBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                            <div class="col-12">
                            ...
                            <div class ="col-3">
                                <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Fixed Days:"></asp:Label>
                            </div>
                            <div class ="col-2">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtb_fixed_days" Visible="true" Enabled="true" runat="server" Width="60%" CssClass="form-control form-control-sm" Style="font-weight: bold; letter-spacing: 3px; text-align:center;"></asp:TextBox>
                           ...
                           <div class="row" style="margin-bottom: 10px; padding-left: 10px;">
                                ...
                                <div class="col-6" style="margin-bottom:-5px">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_empl_type" runat="server"  width="220px" CssClass="form-control-sm form-control" OnSelectedIndexChanged="ddl_empl_type_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9" style="margin-left:-44px;">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_department" width="526px" runat="server" AutoPostBack="true" CssClass="form-control form-control-sm" OnSelectedIndexChanged="ddl_department_SelectedIndexChanged"></asp:DropDownList>
                                ...
                                <div class="col-1" style="margin-left:-4px;">
                                    ...
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="POSITION TITLE" SortExpression="position_title1">
                                                ...
                                                <asp:TemplateField HeaderText="FIXED DAYS" SortExpression="fixed_days">
                                                    <ItemTemplate>
                                                         &nbsp;<%# Eval("fixed_days") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
