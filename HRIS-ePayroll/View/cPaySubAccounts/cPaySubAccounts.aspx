<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPaySubAccounts.aspx.cs" Inherits="HRIS_ePayroll.View.cPaySubAccounts.cPaySubAccounts" %>
                        ...
                        <div class="row" runat="server">
                                <div class="col-4" style="padding-right:0px" >
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <Label ID="Label1" class="col-form-label" ><strong>Sub Account Code:</strong></Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                 </div> 
                                <div class="col-2">
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_subaccount_code" runat="server" CssClass="form-control form-control-sm text-center" MaxLength="2"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    ...
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Sub Account Short Title:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_subaccount_short_description" runat="server"  MaxLength="30"  Width="100%" CssClass="form-control-sm form-control"></asp:TextBox>
                                            <asp:Label ID="LblRequired1" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Sub Account Title:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_subaccount_description" TextMode="MultiLine" Height="80px" runat="server" MaxLength="255"  Width="100%" CssClass="form-control form-control-sm"></asp:TextBox>
                                            <asp:Label ID="LblRequired2" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="form-group col-md-12">
                                        <asp:Label ID="Label5" runat="server" CssClass="font-weight-bold"  Text="Account Class:"></asp:Label>
                                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddl_acctclass" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>
                                                <asp:Label ID="LblRequired5" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <asp:Label ID="Label7" runat="server" CssClass="font-weight-bold"  Text="Account Type:"></asp:Label>
                                        <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddl_accttype" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>
                            ...
                            <div class="row" style="margin-bottom:10px">
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        <div class="col-3">
                                            <asp:Label runat="server" Text="Account Name: "></asp:Label>
                                        </div>
                                        <div class="col-9">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_account" runat="server" CssClass="form-control-sm form-control" OnSelectedIndexChanged="ddl_account_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                           <Columns>
                                                <asp:TemplateField HeaderText="SUB CODE" SortExpression="account_sub_code">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="SHORT TITLE" SortExpression="account_sub_short_title">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("account_sub_short_title") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ACCOUNT TITLE" SortExpression="account_sub_title">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("account_sub_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("account_sub_code") + ", " + Eval("account_sub_short_title") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                ...
                                <Triggers>
                                    ...
                                    <asp:AsyncPostBackTrigger ControlID="ddl_account" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </td>
                    </tr>
