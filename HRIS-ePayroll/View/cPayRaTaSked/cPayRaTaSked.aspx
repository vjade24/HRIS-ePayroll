<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPayRaTaSked.aspx.cs" Inherits="HRIS_ePayroll.View.cPayRaTaSked" %>
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server" style="margin-top:-10px;">
                                <div class="col-12" style="margin-bottom:0px;padding-bottom:0px;">
                                    <div class="row" >
                                        <div class="col-6" style="padding-bottom:0px;margin-bottom:0px; ">
                                             <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Effective Date:"></asp:Label>
                                        </div>
                                        <div class="col-6 text-center">
                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                <ContentTemplate>
                                                    <asp:Label ID="lbl_effective_date" Font-Bold="true" runat="server" Text=""></asp:Label>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12" style="margin-top:-5px;">
                                 <hr style="margin-top:5px;margin-bottom:5px;" />
                                    <div class="row form-group" style="margin-top:0px;">
                                        <div class="col-6" >
                                            <Label ID="Label1" class="col-form-label" ><strong>RATA Type :</strong></Label>
                                        </div>
                                        <div class="col-6 text-left">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddl_rata_type" CssClass="form-control" runat="server">
                                                        <asp:ListItem Value="" Text="--Select Here--"></asp:ListItem>
                                                        <asp:ListItem Value="A" Text="Attendance"></asp:ListItem>
                                                        <asp:ListItem Value="V" Text="Vehicle Usage"></asp:ListItem>
                                                    </asp:DropDownList>
                                ...
                                <div class="col-12">
                                    <div class="row form-group">
                                        <asp:Label ID="Label3" runat="server" CssClass="col-6 font-weight-bold"  Text="Max No. Days :"></asp:Label>
                                        <div class="col-6">
                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtb_max_no_days"  runat="server"  MaxLength="3"  Width="100%" CssClass=" form-control"></asp:TextBox>
                                ...
                                <div class="col-12">
                                    <div class="row form-group">
                                        <asp:Label ID="Label2" runat="server" CssClass="col-6 font-weight-bold" style="padding-right:0px;"  Text="Rate Percentage :"></asp:Label>
                                        <div class="col-6">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <asp:TextBox ID="txtb_rate_percent" runat="server" MaxLength="3"  Width="100%" CssClass="form-control"></asp:TextBox>
                                ...
                                <ContentTemplate>
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="RATA TYPE" SortExpression="rate_type_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("rate_type_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="28%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="MAX No. DAYS" SortExpression="no_of_days_max">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("no_of_days_max") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="15%" />
                                               ...
                                               <asp:TemplateField HeaderText="RATE PERCENT" SortExpression="rate_percentage_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("rate_percentage_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="15%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("effective_date")+","+Eval("rate_type")+","+Eval("no_of_days_max") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%#Eval("effective_date")+","+Eval("rate_type")+","+Eval("no_of_days_max") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
