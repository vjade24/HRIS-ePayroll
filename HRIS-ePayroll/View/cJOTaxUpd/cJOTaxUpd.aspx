<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cJOTaxUpd.aspx.cs" Inherits="HRIS_ePayroll.View.cJOTaxUpd.cJOTaxUpd" %>
                ...
                <div class="modal fade" id="approval_confirm_popup">
                    ...
                    <!-- Modal body -->
                        ...
                        <div style="margin-bottom:50px">
                            <asp:LinkButton ID="lnkBtnYes" OnCommand="btn_approval_Click" runat="server"  CssClass="btn btn-warning"> <i runat="server" id="id_approveall_icn" class="fa fa-check"></i> <asp:Label ID="approval_footer" runat="server" Text="Yes"></asp:Label></asp:LinkButton>
              ...
              <!-- Modal Delete -->
                <div class="modal fade" id="approve_all_confirm_popup">
                    ...
                    <!-- Modal body -->
                        ...
                        <!-- Modal footer -->
                        <div style="margin-bottom:50px">
                            <asp:LinkButton ID="lnkbtn_approve_all" OnCommand="lnkbtn_approve_all_Command" runat="server"  CssClass="btn btn-success"> <i class="fa fa-check"></i> <asp:Label ID="Label6" runat="server" Text="Yes, Approve All"></asp:Label></asp:LinkButton>
                                    ...
                                    <div class="row" style="margin-top: -10px;">
                                        ...
                                        <div class="col-4">
                                            <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                                <ContentTemplate>
                                                    <asp:Label runat="server" Text="Basic Tax :" CssClass="font-weight-bold text-left" ></asp:Label>
                                         ...
                                         <div class="col-4">
                                            <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                                                <ContentTemplate>
                                                    <asp:Label runat="server" Text="Addl. Tax :" CssClass="font-weight-bold text-left" ></asp:Label>
                                                    <asp:TextBox runat="server" ID="txtb_addl_tax_rate" CssClass="form-control form-control-sm text-center font-weight-bold" Enabled="false" style="float:right;width:40%" ></asp:TextBox>
                                        ...
                                        <div class="col-4">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <asp:Label runat="server" Text="Vat Perc :" CssClass="font-weight-bold text-left" ></asp:Label>
                                                    <asp:TextBox runat="server" ID="txtb_vat_perc" CssClass="form-control form-control-sm text-center font-weight-bold" Enabled="false" style="float:right;width:40%" ></asp:TextBox>
                                ...
                                <ContentTemplate>
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                               ...
                                               <asp:TemplateField HeaderText="BSC. TAX" SortExpression="basic_tax_rate">
                                                    <ItemTemplate>
                                                        <%# Eval("basic_tax_rate") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                ...
                                                <asp:TemplateField HeaderText="ADDL. TAX" SortExpression="tax_perc">
                                                    <ItemTemplate>
                                                        <%# Eval("tax_perc") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                               ...
                                               <asp:TemplateField HeaderText="VAT" SortExpression="vat_perc">
                                                    <ItemTemplate>
                                                        <%# Eval("vat_perc") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="5%" />
