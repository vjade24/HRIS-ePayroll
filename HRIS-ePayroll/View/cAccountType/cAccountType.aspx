<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cAccountType.aspx.cs" Inherits="HRIS_ePayroll.View.cAccountType" %>
            ...
            <ContentTemplate>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" >
                                <div class="col-12" >
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                                <label class="font-weight-bold" Style="float:left; margin-right:5px" >Account Type Code:</label>
                                                <asp:TextBox ID="txtb_code" runat="server" Width="15%" Style="float:left" Font-Bold="true" CssClass="form-control form-control-sm text-center" MaxLength="02"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                        </div> 
                        ...
                        <div class="row" >
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Account Type Short Description:"></asp:Label>
                                ...
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Account Type Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_descr" TextMode="MultiLine" Height = "80px" runat="server" MaxLength="150"  Width="100%" CssClass="form-control"></asp:TextBox>
                                            <asp:Label ID="LblRequired2" CssClass="lbl_required" runat="server" Text=""></asp:Label>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold"  Text="Account Type Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                                <asp:DropDownList ID="ddl_accttype_sub" runat="server" CssClass="form-control form-control-sm" AppendDataBoundItems="true" AutoPostBack="True"  Width="100%" >
                                                    <asp:ListItem Text="Non-Deductable to Gross Pay" Selected="True" Value="1" />
                                                    <asp:ListItem Text="Deductable to Gross Pay"  Value="2" />
                                                </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                           <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="accttype_code">
                                                    <ItemTemplate>
                                                        <%# Eval("accttype_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="15%" />
                                                ...
                                                <asp:TemplateField HeaderText="SHORT DESCRIPTION" SortExpression="accttype_short_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("accttype_short_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="DESCRIPTION" SortExpression="accttype_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("accttype_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("accttype_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("accttype_code") + ", " + Eval("accttype_code") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
