...
// PURPOSE          :   Code Behind for Account Type
//**********************************************************************************
// REVISION HISTORY
//**********************************************************************************
// AUTHOR                    DATE            PURPOSE
...
{
    public partial class cAccountType : System.Web.UI.Page
    {
        //********************************************************************
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["ep_user_id"] != null)
            {
                if (!IsPostBack)
                {
                    Session["SortField"] = "accttype_code";
        ...
        {
            dataListGrid = MyCmn.RetrieveData("sp_accounttype_tbl_list");
        ...
        private void InitializeTable()
        {
            ...
            dtSource.Columns.Add("accttype_short_descr", typeof(System.String));
            dtSource.Columns.Add("accttype_descr", typeof(System.String));
            dtSource.Columns.Add("accttype_sub", typeof(System.String));
        }
        ...
        {
            dtSource.TableName = "accounttype_tbl";
            dtSource.Columns.Add("action", typeof(System.Int32));
            dtSource.Columns.Add("retrieve", typeof(System.Boolean));
            string[] col = new string[] { "accttype_code" };
        ...
        protected void deleteRow_Command(object sender, CommandEventArgs e)
        {
            ...
            deleteRec1.Text = "Are you sure to delete this Account Type = (" + appttype.Trim() + ") - " + appttypedescr.Trim() + " ?";
        ...
        protected void btnDelete_Command(object sender, CommandEventArgs e)
        {
            ...
            string deleteExpression = "accttype_code = '" + svalues + "'";

            MyCmn.DeleteBackEndData("accounttype_tbl", "WHERE " + deleteExpression);
        ...
        {
            string svalues = e.CommandArgument.ToString();
            string editExpression = "accttype_code = '" + svalues + "'";
            ...
            txtb_descr.Text = row2Edit[0]["accttype_descr"].ToString();
            txtb_short_descr.Text = row2Edit[0]["accttype_short_descr"].ToString();
            ddl_accttype_sub.SelectedValue = row2Edit[0]["accttype_sub"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (IsDataValidated())
            {
                ...
                {
                    dtSource.Rows[0]["accttype_code"] = txtb_code.Text.ToString();
                    dtSource.Rows[0]["accttype_short_descr"] = txtb_short_descr.Text.ToString();
                    dtSource.Rows[0]["accttype_descr"] = txtb_descr.Text.ToString();
                    dtSource.Rows[0]["accttype_sub"] = ddl_accttype_sub.SelectedValue.ToString();
                ...
                if (saveRecord == MyCmn.CONST_ADD || saveRecord == MyCmn.CONST_EDIT)
                {
                    if (saveRecord == MyCmn.CONST_ADD)
                    {
                        ...
                        nrow["accttype_code"] = txtb_code.Text.ToString();
                        nrow["accttype_short_descr"] = txtb_short_descr.Text.ToString();
                        nrow["accttype_descr"] = txtb_descr.Text.ToString();
                        nrow["accttype_sub"] = ddl_accttype_sub.SelectedValue.ToString();
                    ...
                    {
                        string editExpression = "accttype_code = '" + txtb_code.Text.ToString() + "'";
                        DataRow[] row2Edit = dataListGrid.Select(editExpression);
                        row2Edit[0]["accttype_code"] = txtb_code.Text.ToString();
                        row2Edit[0]["accttype_short_descr"] = txtb_short_descr.Text.ToString();
                        row2Edit[0]["accttype_descr"] = txtb_descr.Text.ToString();
                        row2Edit[0]["accttype_sub"] = ddl_accttype_sub.SelectedValue.ToString();
                        MyCmn.Sort(gv_dataListGrid, dataListGrid, Session["SortField"].ToString(), Session["SortOrder"].ToString());
        ...
        {
            string searchExpression = "accttype_code LIKE '%" + tbx_search.Text.Trim().Replace("'", "''") + "%' OR accttype_short_descr LIKE '%" + tbx_search.Text.Trim().Replace("'", "''") + "%' OR accttype_descr LIKE '%" + tbx_search.Text.Trim().Replace("'", "''") + "%'";

            DataTable dtSource1 = new DataTable();
            dtSource1.Columns.Add("accttype_code", typeof(System.String));
            dtSource1.Columns.Add("accttype_short_descr", typeof(System.String));
            dtSource1.Columns.Add("accttype_descr", typeof(System.String));
            dtSource1.Columns.Add("accttype_sub", typeof(System.String));
