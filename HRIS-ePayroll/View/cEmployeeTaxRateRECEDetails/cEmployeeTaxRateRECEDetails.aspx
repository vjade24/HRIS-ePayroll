<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cEmployeeTaxRateRECEDetails.aspx.cs" Inherits="HRIS_ePayroll.View.cEmployeeTaxRateRECEDetails.cEmployeeTaxRateRECEDetails" %>
                            ...
                            <div class="modal-body with-background" runat="server">
                                <div class="row" runat="server">
                                    ...
                                    <div class="col-5">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:TextBox ID="txtb_empl_name" runat="server" Width="100%" CssClass="form-control form-control-sm" Enabled="false" Style="font-weight: bold;"></asp:TextBox>
                                   ...
                                   <div class="col-3">
                                    ...
                                    <div class="col-5">
                                        <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:TextBox ID="txtb_position" runat="server" Width="100%" CssClass="form-control form-control-sm" Enabled="false" Style="font-weight: bold;"></asp:TextBox>
                                    ...
                                    <div class="col-2">
                                         <asp:Label runat="server" Font-Bold="true" Text="Tax Due:"></asp:Label>
                                    </div>
                                    <div class="col-2">
                                        <asp:UpdatePanel ID="UpdatePanel25" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtb_tax_due_dtl" runat="server" Width="100%" CssClass="form-control form-control-sm text-right" Enabled="false" Style="font-weight: bold;"></asp:TextBox>
                                    ...
                                    <div class="col-2 input-group">
                                        <asp:UpdatePanel ID="UpdatePanel20" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:TextBox ID="txtb_tax_rate_dtl" runat="server" Width="100%" CssClass="form-control form-control-sm text-right" Enabled="false" Style="font-weight: bold; letter-spacing: 3px;padding-right:27px;"></asp:TextBox>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                   <asp:TextBox ID="txtb_employment_type" runat="server" CssClass="form-control form-control-sm text-left" Enabled="false" Style="font-weight: bold;"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group row">
                                        <div class="col-6">
                                             <label>Mon.Tax Due:</label>
                                        </div>
                                        <div class="col-6">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                   <asp:TextBox ID="txtb_tax_due" runat="server" CssClass="form-control form-control-sm text-right" Enabled="false" Style="font-weight: bold;"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                 ...
                                 <div class="col-3">
                                    ...
                                    <asp:UpdatePanel runat="server">
                                        <ContentTemplate>
                                            <a ID="lb_back" class="btn btn-info btn-sm font-weight-bold" href="/View/cEmplTaxWithHeld/cEmplTaxWithHeld.aspx" ><i class="fa fa-arrow-left"></i> Back To Tax Rate Header</a>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-3">
                                    <div class="form-group row">
                                        <div class="col-6">
                                             <label>Mon.Tax Rate:</label>
                                        </div>
                                        <div class="col-6">
                                            <asp:UpdatePanel runat="server">
                                                <ContentTemplate>
                                                    <span style="position:absolute;float:right;right:15%;padding-top:2px; padding-right:5px;color:lightgray;">| %</span>
                                                   <asp:TextBox ID="txtb_tax_rate" runat="server" CssClass="form-control form-control-sm text-center" Enabled="false" Style="font-weight: bold;padding-right:27px;"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="VCH NBR" SortExpression="voucher_nbr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("voucher_nbr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="8%" />
                                                ...
                                                <asp:TemplateField HeaderText="GSIS PS" SortExpression="gsis_ps">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("gsis_ps","{0:N2}") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                ...
                                                <asp:TemplateField HeaderText="HDMF PS" SortExpression="hdmf_ps">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("hdmf_ps","{0:N2}") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                ...
                                                <asp:TemplateField HeaderText="PHIC PS" SortExpression="phic_ps">
                                                    <ItemTemplate>
                                                        &nbsp;<%# Eval("phic_ps","{0:N2}") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="10%" />
                                                            ...
                                                            <ContentTemplate>
                                                                ...
                                                                %>
                                                                    <asp:ImageButton 
                                                                        ...
                                                                        CommandArgument='<%# Eval("empl_id") + "," + Eval("voucher_nbr") + "," + Eval("payroll_year")%>'
                                                                        tooltip="View"
                                                                        />
