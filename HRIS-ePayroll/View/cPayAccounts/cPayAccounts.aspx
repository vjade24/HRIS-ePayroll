<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPayAccounts.aspx.cs" Inherits="HRIS_ePayroll.View.cPayAccounts.cPayAccounts" %>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                <div class="col-12" >
                                    <Label ID="Label1" style="float:left;margin-right:10px"><strong>Account Code:</strong></Label>
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_code" runat="server" Width="30%" CssClass="form-control form-control-sm" MaxLength="10" style="float:left"></asp:TextBox>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                 </div>
                                <div class="col-3"></div>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Account Short Title:"></asp:Label>
                                ...
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label4" runat="server" CssClass="font-weight-bold"  Text="Nature of Account:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddl_nature_of_account" runat="server" CssClass="form-control form-control-sm">
                                ...
                                <ContentTemplate>
                                    <asp:GridView 
                                           ...
                                           <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="SHORT TITLE" SortExpression="account_short_title">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("account_short_title") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="25%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("account_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("account_code") + ", " + Eval("account_short_title") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
