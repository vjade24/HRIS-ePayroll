<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cPayAccountGroups.aspx.cs" Inherits="HRIS_ePayroll.View.cPayAccountGroups.cPayAccountGroups" %>
                ...
                <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-content" style="background-image:linear-gradient(white, lightblue)">
                        ...
                        <div class="row" runat="server">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-12 text-left">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <ContentTemplate>
                                                    <Label ID="Label1" class="col-form-label" ><strong>Group Code:</strong></Label>
                                                    <asp:TextBox ID="txtb_subaccount_code" runat="server" Width="15%" CssClass="form-control form-control-sm text-center" Enabled ="false" Font-Bold="true"></asp:TextBox>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <asp:Label ID="Label3" runat="server" CssClass="font-weight-bold"  Text="Group Short Description:"></asp:Label>
                                ...
                                <div class="form-group col-md-12">
                                    <asp:Label ID="Label2" runat="server" CssClass="font-weight-bold"  Text="Group Description:"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <asp:TextBox ID="txtb_subaccount_description" TextMode="MultiLine" Height = "80px" runat="server" MaxLength="255"  Width="100%" CssClass="form-control"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="up_dataListGrid" UpdateMode="Conditional" runat="server" >
                                <ContentTemplate>
                                    <asp:GridView 
                                            ...
                                            >
                                           <Columns>
                                                <asp:TemplateField HeaderText="CODE" SortExpression="group_code">
                                                    <ItemTemplate>
                                                        <%# Eval("group_code") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="5%" />
                                                ...
                                                <asp:TemplateField HeaderText="GROUP SHORT-DESCRIPTION" SortExpression="group_short_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("group_short_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="35%" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="GROUP DESCRIPTION" SortExpression="group_descr">
                                                    <ItemTemplate>
                                                        &nbsp;<%# " "+Eval("group_descr") %>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="40%" />
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel12" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                                                            <ContentTemplate>
                                                                <% 
                                                                    ...
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="imgbtn_editrow1" CssClass="btn btn-primary action" EnableTheming="true"  runat="server"  ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("group_code") %>'/>
                                                                ...
                                                                <% if (ViewState["page_allow_delete"].ToString() == "1")
                                                                    {
                                                                %>
                                                                    <asp:ImageButton ID="lnkDeleteRow" CssClass="btn btn-danger action" EnableTheming="true" runat="server"  ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("group_code") + ", " + Eval("group_short_descr") %>'/>
                                                                <% }
                                                                %>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
