...
namespace HRIS_Common
{
    ...
    class CommonDB
    {
        ...
        // Date Created :   09/07/2018
        //****************************************************************
        public SqlConnection ConnectDB_aats()
        {
            try
            {
                string ConnectString = ConfigurationManager.ConnectionStrings[connectstring_aats].ConnectionString;
                SqlConnection conn;
                conn = new SqlConnection(ConnectString);
                return conn;
            }
        ...
        //***********************************************************************************************************************
        // Purpose      :   Create Overloaded Datatable with 5 parameters
        // Method Name  :   RetrieveData
        // Created By   :   VINCENT JADE ALIVIO (VJA)
        ...
        public string GetLastRow_of_Table_to_aats(string select_script)
        //***********************************************************************************************************************
        ...
        // Date Created :   09/07/2018
        //***********************************************************************************************************************
        public DataTable RetrieveData_to_aats(string sp_script)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        // Date Created :   09/07/2018
        //***********************************************************************************************************************
        public DataTable RetrieveData_to_aats(string sp_script, string parmagr1, string parmvalue1)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        // Date Created :   09/07/2018
        //***********************************************************************************************************************
        public DataTable RetrieveData_to_aats(string sp_script, string parmagr1, string parmvalue1, string parmagr2, string parmvalue2, string parmagr3, string parmvalue3)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        // Date Created :   09/07/2018
        //***********************************************************************************************************************
        public DataTable RetrieveData_to_aats(string sp_script, string parmagr1, string parmvalue1, string parmagr2, string parmvalue2, string parmagr3, string parmvalue3, string parmagr4, string parmvalue4, string parmagr5, string parmvalue5)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        // Date Created :   09/07/2018
        //***********************************************************************************************************************
        public DataTable RetrieveData_to_aats(string sp_script, string parmagr1, string parmvalue1, string parmagr2, string parmvalue2)
        {
            try
            {
                DataTable dt = new DataTable();
        ...
        //***********************************************************************************************************************
        // Purpose      :   Create 9 Parameter Overloaded Datatable object based SQL script 
        // Method Name  :   RetrieveData
        // Created By   :   Vincent Jade Alivio
        ...
        //***********************************************************************************************************************
        // Purpose      :   Create 10 Parameter Overloaded Datatable object based SQL script 
        // Method Name  :   RetrieveData
        // Created By   :   Vincent Jade Alivio
        // Date Created :   05/30/2019
        //***********************************************************************************************************************
        public DataTable RetrieveData(string sp_script, string parmagr1, string parmvalue1, string parmagr2, string parmvalue2, string parmagr3, string parmvalue3, string parmagr4, string parmvalue4, string parmagr5, string parmvalue5, string parmagr6, string parmvalue6, string parmagr7, string parmvalue7, string parmagr8, string parmvalue8, string parmagr9, string parmvalue9, string parmagr10, string parmvalue10)
        {
            try
            {
                DataTable dt = new DataTable();
                ...
                using (SqlConnection cn = new SqlConnection(connStr))
                {
                    ...
                    cmd.Parameters.Add("@" + parmagr8, SqlDbType.VarChar).Value = parmvalue8;
                    cmd.Parameters.Add("@" + parmagr9, SqlDbType.VarChar).Value = parmvalue9;
                    cmd.Parameters.Add("@" + parmagr10, SqlDbType.VarChar).Value = parmvalue10;
                    adp.Fill(dt);
                }
                return dt;
            }
        ...
        //***********************************************************************************************************************
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@par_effective_date", SqlDbType.VarChar).Value = parmvalue4;
                cmd.Parameters.Add("@par_copy_only", SqlDbType.VarChar).Value = parmvalue5;
        ...
        // Date Created :   10/02/2018
        //***********************************************************************************************************************
        public string DeleteBackEndData_to_aats(string tablenamescript, string whereclause)
        {
            string sdeletescript = "delete from " + tablenamescript + " " + whereclause;
        ...
        // Date Created :   10/02/2018
        //***********************************************************************************************************************
        public string Update_InsertTable(string insert_update_script)
        {
            string sdeletescript = insert_update_script;

            return connectandsetcommand(sdeletescript, "insert_update");
        }
        //***********************************************************************************************************************
        // Purpose      :   Update Data to Back End Database
        // Method Name  :   UpdateTable
        ...
        // Date Created :   10/02/2018
        //***********************************************************************************************************************
        public string UpdateTable_to_aats(string tablenamescript, string setparm, string whereparm)
        {
            string sdeletescript = "update " + tablenamescript + " set " + setparm + "  " + whereparm;

            return connectandsetcommand_to_aats(sdeletescript, "update");
        }
        //***********************************************************************************************************************
        // Purpose      :   Update Data to Back End Database
        // Method Name  :   UpdateTable
        ...
        public string connectandsetcommand_to_aats(string sparm, string actionparm)
        {
            SqlConnection conn = null;
            string msg = "";
            try
        ...
        public string insertdata_to_aats(string script)
        {
            SqlConnection conn = null;
            try
            {
